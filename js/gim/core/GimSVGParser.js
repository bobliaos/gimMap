...
var GimSVGParser = {
    ...
    getSVGObject: function () {
        ...
        obj.pathes = [
            ...
            /// Keelung City
//                "M481.1,181.7 L450.7,129 L481.1,76.4 L541.9,76.4 L572.3,129 L541.9,181.7Z ",
                "M409.5,244.3c0,0-2.4-46,39.4-17.5c41.7,28.4,57.4,52.2,22.8,56.4C437,287.5,409.5,244.3,409.5,244.3z" +
                "M559.6,220.3c34.6-4.3,19-28-22.8-56.4c-41.7-28.4-39.4,17.5-39.4,17.5S525,224.6,559.6,220.3z" +
                "M265.5,289.7c0,0,33.9-132.3,111.9-50.9c78,81.4,0,117,113.6,71.2c113.6-45.8,11.9-63.1-10.2-97.7" +
                "c-22-34.6-103.1-57.8-23.6-86c79.6-28.3,138.9,31.1,159.3,68.4s37.3,84.5,20.4,135.5c-17,51-71.2,83.3" +
                "-125.5,93.4c-54.3,10.2-171.3,3.4-198.4-15.3C285.9,389.7,265.5,289.7,265.5,289.7z",
//                "M308.5,167 c0,6.6 -5.4,12 -12,12 h-76 c-6.6,0 -12 -5.4 -12 -12 V91 c0 -6.6,5.4 -12,12 -12 h76 c6.6,0,12,5.4,12,12 V167z",
            /// Taipei County
        ...
        obj.amounts = [50, 30, 20];
        obj.colors = [0xFF0033, 0xC08000, 0x0099CC];
        obj.center = {x: 0, y: 0};
